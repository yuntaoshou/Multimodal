...
def main(audio_dir, save_dir, feature_level, dir_name=None, overwrite=False, gpu=None):
    ...
    # load model
    device = torch.device(f'cuda:{gpu}')
    model_file = os.path.join("/home/lkshpc/syt/multimodal/datasets/MELD/MELDRaw/pretrain_model", f'wav2vec_large.pt')
...
if __name__ == '__main__':
    ...
    audio_dir = "/home/lkshpc/syt/multimodal/datasets/MELD/MELDRaw/train_splits_audio"
    save_dir = "/home/lkshpc/syt/multimodal/datasets/MELD/MELDRaw/train_splits_audio"
